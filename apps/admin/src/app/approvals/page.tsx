...
import { canDecide, type ApprovalItem } from "@/lib/admin/approvals"
...
export default function ApprovalsPage() {
  ...
  const columns: DataColumn<ApprovalItem>[] = [
    ...
    { key: "requested", header: "Requested", value: (r) => r.requestedAt, sortable: true, cell: (r) => when(r.requestedAt) },
    ...
    <div>
      ...
      <ConfirmReasonDialog
        ...
        description={
          pending ? (
            <>
              <span className="font-semibold text-mo-ink">{pending.item.summary}</span> ({pending.item.appLabel}).{" "}

...
/**
 * Know It's own section strip, under the shared frame's header: Home, Topics,
...
export function KwitNav() {
  const pathname = usePathname() ?? "/"
  const { signedOut } = useSession()

  return (
    <nav aria-label="Know It" className="mb-5">
      <p className="mb-2 font-mo-display text-2xl font-semibold tracking-mo-display text-mo-ink">Know It</p>

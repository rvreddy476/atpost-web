/**
 * Every user-facing string in Ask, in one place. Mirrors Android's QaCopy.kt
...
export const COPY = {
  ...
  notAvailableTitle: "Ask isn't available yet",
  notAvailableBody:
  ...
  // Settings › Ask. Separate from the app-wide notification settings.
  settingsTitle: "Ask settings",
  settingsIntro:
    "These are Ask's own settings. They are separate from your app-wide notification settings, and changing one does not change the other.",
  ...
  signInForSettings: "Sign in to change your Ask settings",
  signInForSettingsBody: "Ask settings are kept against your account.",

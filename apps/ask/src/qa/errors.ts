/**
 * The Ask failures a screen renders distinctly — the web twin of Android's
 ...
 * body, or with no `meta`, is "Ask isn't available" — a calm state, not an
...
export function errorMessage(error: unknown): string {
  ...
  switch (e.kind) {
    case "notAvailable":
      return "Ask isn't available yet."
    case "signInRequired":

/**
 * The four states every Ask screen draws besides its content: loading,
 * empty, failed, and "Ask isn't available yet" (the gateway's dormant gate).
 */
...
/** A calm screen: Ask is dark for this reader. Never styled as an error. */
